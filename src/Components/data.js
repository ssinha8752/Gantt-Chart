...
exports.projectNewData = [
    {
        ...
        subtasks: [
            { TaskID: 2, TaskName: 'Defining the product and its usage', StartDate: new Date('04/02/2019'), Duration: 3, Progress: 60 },
    ...
    {
        TaskID: 5, TaskName: 'Concept approval', StartDate: new Date('04/02/2019'), Predecessor: '3,4',
        Indicators: [
            {
                'date': '04/10/2019',
                'name': 'Design Phase',
